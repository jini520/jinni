package site.jejinni.server.domain.education.service;

import lombok.RequiredArgsConstructor;
import org.springframework.stereotype.Service;
import org.springframework.transaction.annotation.Transactional;
import site.jejinni.server.domain.education.entity.Education;
import site.jejinni.server.domain.education.dto.EducationDto;
import site.jejinni.server.domain.education.dto.EducationRequestDto;
import site.jejinni.server.global.response.ApiResponse;
import site.jejinni.server.global.exception.NotFoundException;
import site.jejinni.server.domain.education.repository.EducationRepository;
