...
import site.jejinni.server.domain.file.entity.File;
import site.jejinni.server.domain.file.dto.FileDto;
import site.jejinni.server.domain.file.dto.FileListDto;
import site.jejinni.server.global.exception.BadRequestException;
import site.jejinni.server.domain.file.repository.FileRepository;
